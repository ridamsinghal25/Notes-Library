        ...
        <div className="w-full max-w-4xl px-4 py-8">
          <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-16 gap-y-24">
            <div className="text-center md:text-left md:w-2/3">
              <h1 className="text-2xl md:text-4xl font-bold text-gray-850 font-inter mb-2">
              ...
              <h1 className="text-2xl md:text-4xl font-bold text-gray-850 font-inter mb-4">
                {TEXT_CONTENT.SUB_TITLE_SUFFIX}
              </h1>
              <p className="text-sm md:text-base text-gray-850 mb-6">
                {TEXT_CONTENT.DESCRIPTION_ONE}
                <br className="md:hidden" />
                {TEXT_CONTENT.DESCRIPTION_TWO}.
              </p>
