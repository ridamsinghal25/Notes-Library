          ...
          {url?.map((url, index) => (
            ...
            >
              <div className="w-3/4">
                ...
                <p className="text-gray-700 mb-4 font-medium">OOAD</p>
        ...
        <aside className="w-full lg:w-1/3 lg:mt-9 relative lg:pl-8">
          <div className="bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 p-6 text-center relative">
            <div className="flex lg:flex-col gap-4">
              ...
              <div className="">
                <h3 className="text-xl font-semibold text-gray-900 hover:text-gray-700 transition-colors duration-300 mt-4">
                  Matthew Mamonov
                </h3>
              </div>
            </div>
                  ...
                  <div className="space-y-4 mt-3 sm:space-y-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-800">B.Tech</p>
                      </div>
                    </div>
                    <div>
                      <button
